...
import kotlinx.android.synthetic.main.holder_ranking_favoritos.view.*

class RankingFavoritadosViewHolder(view: View, val context: Context) : RecyclerView.ViewHolder(view), View.OnClickListener {
    ...
    fun bind(local: ViewType) {
        ...
        if (local is Estabelecimento) {
            ...
            localNota.text = local.qtdFavoritos.toString()
